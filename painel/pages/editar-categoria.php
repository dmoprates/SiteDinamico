<?php 
	if(isset($_GET['id'])){
		$id = (int)$_GET['id'];
		$categoria = Painel::select('site.categorias','id = ?',array($id));
	}else{
	...
	<form method="post" enctype="multipart/form-data">
		...
		<?php
			if(isset($_POST['acao'])){
				...
				$verificar = MySql::conectar()->prepare("SELECT * FROM `site.categorias` WHERE nome = ? AND id != ?");
		...
		<div class="form-group">
			...
			<input type="hidden" name="nome_tabela" value="site.categorias" />
