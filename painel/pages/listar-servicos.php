...
if (isset($_GET['excluir'])) {
    ...
    Painel::deletar('site.servicos', $idExcluir);
    Painel::redirect(INCLUDE_PATH_PAINEL . 'listar-servicos');
} else if(isset($_GET['order']) && isset($_GET['id'])){
		Painel::orderItem('site.servicos',$_GET['order'],$_GET['id']);
	}


$paginaAtual = isset($_GET['pagina']) ? (int) $_GET['pagina'] : 1;
$porPagina = 4;
$servicos = Painel::selectAll('site.servicos', ($paginaAtual - 1) * $porPagina, $porPagina * $paginaAtual);
...
<div class="box-content">
    ...
    <div class="wraper-table">
        <table>
            <tr>
                <td><i class="fa-solid fa-comments"></i> Serviço</td>
    ...
    <div class="paginacao">
        <?php
        $totalPaginas = ceil(count(Painel::selectAll('site.servicos')) / $porPagina);
