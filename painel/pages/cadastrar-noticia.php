<div class="box-content">
	...
	<form method="post" enctype="multipart/form-data">
			...
			if(isset($_POST['acao'])){
				...
				if($titulo == '' || $conteudo == ''){
					...
					if(Painel::imagemValida($capa)){
						$verifica = MySql::conectar()->prepare("SELECT * FROM `site.noticias` WHERE titulo=? AND categoria_id = ?");
		...
		<div class="form-group">
			...
			<input type="hidden" name="nome_tabela" value="site.noticias" />
